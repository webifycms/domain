 ...
 */
final class UserAlreadyActivateException extends LogicException implements TranslatableExceptionInterface
{
	/**
	 * {@inheritDoc}
	 */
	 ...
	 * The constructor.
	 */
	public function __construct(string $message = 'User is already activate')
	{
