...
/**
 * Exception thrown when an invalid role assignment id value is encountered.
 */
final class InvalidRoleAssignmentIdException extends InvalidArgumentException implements TranslatableExceptionInterface
{
	/**
	...
	public static function fromInvalidId(string $value): self
	{
		return new self(
			...
			sprintf('Invalid role assignment id "%s"', $value)
		);
	}
}
