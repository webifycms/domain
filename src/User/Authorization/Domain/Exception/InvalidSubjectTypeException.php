...
/**
 * Exception thrown when an invalid subject type value is encountered.
 */
final class InvalidSubjectTypeException extends InvalidArgumentException implements TranslatableExceptionInterface
{
	/**
	...
	/**
	 * Factory method to initiate an InvalidSubjectTypeException with a default message.
	 *
	 * @param string $value the invalid subject id value
	 */
	public static function fromInvalidType(string $value): self
	{
		return new self(
