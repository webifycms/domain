...
/**
 * Exception thrown when an invalid role id value is encountered.
 */
final class InvalidRoleIdException extends InvalidArgumentException implements TranslatableExceptionInterface
{
	/**
	 ...
	 *
	 * @param string $value the invalid role id value
	 */
	public static function fromInvalidId(string $value): self
	{
		return new self(
			...
			sprintf('Invalid role id "%s"', $value)
		);
	}
}
