...
/**
 * Exception thrown when an invalid session ID is encountered.
 */
final class InvalidSessionIdException extends InvalidArgumentException implements TranslatableExceptionInterface
{
	/**
	 ...
	 */
	public static function forInvalidId(string $id): InvalidSessionIdException
	{
		return new self(
