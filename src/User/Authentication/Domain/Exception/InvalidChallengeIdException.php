...
/**
 * Exception thrown when an invalid challenge ID is encountered.
 */
final class InvalidChallengeIdException extends InvalidArgumentException implements TranslatableExceptionInterface
{
	/**
	 ...
	 */
	public static function forInvalidId(string $id): InvalidChallengeIdException
	{
		return new self(
