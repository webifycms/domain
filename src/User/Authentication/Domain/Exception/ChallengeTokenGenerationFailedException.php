...
/**
 * Exception thrown when challenge token generation fails.
 */
final class ChallengeTokenGenerationFailedException extends RuntimeException implements TranslatableExceptionInterface
{
	/**
	 ...
	 */
	public static function create(Throwable $throwable): ChallengeTokenGenerationFailedException
	{
		return new self(
			$throwable,
			new ExceptionTranslation(
				'user.authentication',
				'challenge_token_generation_failed',
			),
			'Unable to generate secure challenge token.',
		);
	}
}
