...
/**
 * Exception thrown when an invalid authentication challenge type is encountered.
 */
final class InvalidChallengeTypeException extends InvalidArgumentException implements TranslatableExceptionInterface
{
	/**
	 ...
	 */
	public static function forInvalidType(string $type): InvalidChallengeTypeException
	{
		return new self(
			...
			sprintf('The authentication challenge type "%s" is invalid.', $type)
		);
	}
}
